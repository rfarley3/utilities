...
# for font in fonts:
#    print("font: " + font)
# .../pyfiglet-master $ ls -l pyfiglet/fonts/ |
# grep -v '^total' | grep -v py$ | sed -e "s/.*:33 /, '/" |
# sed  -e "s/_*.flf.*/'/" | paste -s -d" " -
...
if __name__ == "__main__":
    ...
    while(1):
        ...
        if (ctrl_char != "" and
           (ctrl_char[0].lower() == 'q' or ctrl_char[0].lower() == 'e')):
            sys.exit(0)
        font = "rand"
    # end while
# end main
